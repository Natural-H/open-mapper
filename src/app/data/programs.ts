...
export const programs: Program[] = [
  {
    ...
    description: "GIMP (GNU Image Manipulation Program) es un editor de imágenes gratuito y de código abierto. Ofrece herramientas avanzadas de retoque fotográfico, composición y creación de imágenes.",
  ...
  },
  {
    ...
    description: "Krita es un programa profesional de pintura digital gratuito y de código abierto. Diseñado por artistas para artistas, ofrece herramientas avanzadas para ilustración, concept art y texturizado.",
    category: "image-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Photopea es un editor de imágenes online gratuito que funciona en el navegador. Compatible con formatos PSD, XCF, Sketch y más, ofrece una interfaz similar a Photoshop.",
    category: "image-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Adobe Photoshop es el software profesional líder en edición de imágenes y diseño gráfico.",
    category: "image-editing",
    isProprietary: true,
  ...
  },
  {
    ...
    description: "DaVinci Resolve es un software profesional de edición de video, corrección de color, postproducción de audio y efectos visuales. La versión gratuita ofrece características de nivel profesional.",
  ...
  },
  {
    ...
    description: "Kdenlive es un editor de video de código abierto multiplataforma. Ofrece edición multipista, efectos y transiciones para crear videos profesionales.",
    category: "video-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Shotcut es un editor de video gratuito, de código abierto y multiplataforma. Soporta una amplia variedad de formatos de video sin necesidad de importar.",
    category: "video-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Adobe Premiere Pro es el software profesional líder en edición de video.",
    category: "video-editing",
    isProprietary: true,
  ...
  },
  {
    ...
    description: "Audacity es un editor de audio multipista gratuito y de código abierto. Ideal para grabar, editar y mezclar audio con facilidad.",
  ...
  },
  {
    ...
    description: "Ardour es una estación de trabajo de audio digital profesional. Ofrece grabación multipista, edición y mezcla para producción musical.",
    category: "audio-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Ocenaudio es un editor de audio multiplataforma fácil de usar y rápido. Perfecto para edición de audio simple y efectiva.",
    category: "audio-editing",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Visual Studio Code es un editor de código fuente gratuito y altamente extensible. Soporta depuración, control de Git integrado y múltiples lenguajes de programación.",
  ...
  },
  {
    ...
    description: "VSCodium es Visual Studio Code sin la telemetría de Microsoft. Es completamente de código abierto y respeta tu privacidad.",
    category: "programming",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Atom fue un editor de texto de código abierto desarrollado por GitHub. Nota: El proyecto fue archivado en diciembre de 2022.",
    category: "programming",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Canva es una plataforma de diseño gráfico online que ofrece una versión gratuita con plantillas y herramientas de diseño.",
  ...
  },
  {
    ...
    description: "Inkscape es un editor de gráficos vectoriales profesional y de código abierto. Ideal para ilustraciones, iconos, logotipos y diseño web.",
    category: "graphic-design",
    isProprietary: false,
  ...
  },
  {
    ...
    description: "Figma es una herramienta de diseño de interfaz colaborativa basada en la nube. Ofrece una versión gratuita con funciones completas para equipos pequeños.",
    category: "graphic-design",
    isProprietary: false,
